...
.projects
  ...
  .block
    h3.has-text-centered.is-size-4.mb-3 Pulsar
    p.has-text-centered.mb-3
  ...
  .block
    h3.has-text-centered.is-size-4.mb-3 Personal works
    p.has-text-centered.mb-3
    ...
    .columns.has-text-centered
      ...
      .column
        h4.is-size-3 #[a(href="https://medium.com/@pulsar.dev.team") Blog articles]
